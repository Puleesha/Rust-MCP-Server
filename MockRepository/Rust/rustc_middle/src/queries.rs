...
//! **TODO** The `Providers` struct is not a Rust trait, but a struct generated by the `rustc_macros` to hold all provider functions.
...
rustc_queries! {
    ...
    /// TODO This will ICE on inherent impl items. Consider using `AssocItem::defaultness`.
