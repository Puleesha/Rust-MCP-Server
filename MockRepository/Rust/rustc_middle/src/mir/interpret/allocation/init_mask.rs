...
// TODO for performance reasons when interning, some of the fields can be partially
...
// TODO There is probably a remaining optimization for masks that do not use an entire
// `Block`.
