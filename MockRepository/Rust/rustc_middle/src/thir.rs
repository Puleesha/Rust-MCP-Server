...
macro_rules! thir_with_elements {
    (
        ...
        // TODO: Making `Thir` implement `Clone` is useful for external tools that need access to
...
pub enum ExprKind<'tcx> {
    ...
    Call {
        ...
        ///
        /// TODO in some cases (like calling a closure), the function call `f(...args)` gets
